...
// So here it is likely that you have to let it do its thing and then put your own little snip in here that checks if the chat is a group, then see if the tag is present in the group
// to change the results of the above
