...
import { chat, chat_metadata, main_api, getMaxContextSize, getCurrentChatId, substituteParams, getMaxResponseSizeMGB, getMainPromptMGB } from '../script.js';
...
//MGB EDIT XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
	content = content.replace(/{{maxResponsePromptMGB}}/gi, () => String(getMaxResponseSizeMGB()));
	content = content.replace(/{{mainGlobalDirectiveMGB}}/gi, () => String(getMainPromptMGB()));
//MGB EDIT XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX	
